...
export class FieldSchema {
    ...
    private _isObjectIdString: boolean;
    ...
    constructor(name: string,
        ...
        this._isObjectIdString = isObjectIdString;
    ...
    get isObjectIdString(): boolean {
        return this._isObjectIdString;
    }
