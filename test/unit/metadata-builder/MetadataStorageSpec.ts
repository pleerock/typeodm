...
describe('MetadataStorage', function() {
    ...
    it('should give field metadatas', function () {
        let first = { object: firstTestObject, name: <string> undefined, type: (type: any) => 'string', isId: false, isAutoGenerated: false, isCreateDate: false, isUpdateDate: false, isArray: false, propertyName: 'someProperty' };
        let second = { object: firstTestObject, name: <string> undefined, type: (type: any) => 'string', isId: false, isAutoGenerated: false, isCreateDate: false, isUpdateDate: false, isArray: false, propertyName: 'someProperty2' };
